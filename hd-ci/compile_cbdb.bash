...
function compile_cbdb() {
	...
	export CONFIGURE_FLAGS="--enable-cassert --enable-tap-tests --enable-debug-extensions --with-openssl --enable-openssl-redirect"
	if [[ ${BUILD_TYPE} == "release" ]]; then
		export CPPFLAGS="${CXXFLAGS} -Wno-unused-function -Wno-unused-variable"
		export CONFIGURE_FLAGS="--disable-cassert --disable-tap-tests --disable-debug-extensions --with-openssl --enable-openssl-redirect"
	fi
